...
Guía práctica para la gestión financiera personal.

## 1. Configuración Inicial
- Inicia sesión con tu cuenta de Google.
- Crea tus cuentas (Efectivo, Banco, Billetera) en la sección de Cuentas.
- Define tus categorías de ingresos y gastos en la sección de Categorías.
...
- Usa el botón "Filtrar" para segmentar por rango de fechas, categoría o cuenta específica.
